...
Ajan ohjelman loppuun ja tällä kertaa anna salasanaksi "dalasana", ja huomaan että tällä kertaa ohjelma ajaa vähennys kohtaan saakk. Päättelen tästä että joka toinen kirjain vähennetään ja joka toinen lisää.
